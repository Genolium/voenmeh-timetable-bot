...
from core.schedule_diff import ChangeType, GroupScheduleDiff, LessonChange, ScheduleDiffDetector, ScheduleDiffFormatter
            ...
            "lessons": [
                {
                    ...
                    "room": "201",
                    "teachers": "Сидоров",
                },  # Изменены аудитория и преподаватель
                {
                    "time": "12:20-13:50",
                    "subject": "Химия",
                    "room": "103",
...
class TestScheduleDiffFormatter:
    ...
    def test_format_group_diff_with_changes(self):
        ...
        diff = GroupScheduleDiff(group="О735Б", date=date(2025, 9, 1), changes=changes)
    ...
    def test_format_group_diff_no_changes(self):
        ...
        diff = GroupScheduleDiff(group="О735Б", date=date(2025, 9, 1), changes=[])
