...
from bot.dialogs.find_menu import get_find_data, on_classroom_input, on_item_selected, on_teacher_input
...
class TestFindMenu:
    ...
    async def test_on_item_selected(self, mock_manager):
        ...
        # Classroom
        mock_manager.reset_mock()
        mock_manager.dialog_data = {"search_type": "classroom"}
    ...
    async def test_get_find_data(self, mock_manager, mocker):
        mocker.patch(
            "bot.dialogs.find_menu.format_teacher_schedule_text",
            return_value="Teacher Text",
        )
        mocker.patch(
            "bot.dialogs.find_menu.format_classroom_schedule_text",
            return_value="Classroom Text",
        )

        mock_manager.dialog_data = {
            "teacher_name": "Иванов И.И.",
            "find_date_iso": "2023-10-26",
        }
